...
public class THObject implements ILuaValue, IGetContainer, ISerializable {
    ...
    public static final ResourceLocation TEXTURE_WHITE = ResourceLocationUtil.thdanmakucraft("textures/white.png");
    ...
    public static class LuaAPI {
        ...
        protected static final LibFunction setCollision = new TwoArgFunction() {
            @Override
            public LuaValue call(LuaValue luaValue0, LuaValue luaValue) {
                checkTHObject(luaValue0).collision = (luaValue.checkboolean());
                return LuaValue.NIL;
            }
        };

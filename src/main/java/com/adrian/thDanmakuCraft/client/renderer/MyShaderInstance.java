...
@OnlyIn(Dist.CLIENT)
public class MyShaderInstance implements Shader, AutoCloseable {
    ...
    private static MyShaderInstance lastAppliedShader;
    ...
    public MyShaderInstance(ResourceProvider p_173336_, String p_173337_, VertexFormat p_173338_) throws IOException {
        this(p_173336_, new ResourceLocation(p_173337_), p_173338_);
    }

    public MyShaderInstance(ResourceProvider p_173336_, ResourceLocation shaderLocation, VertexFormat p_173338_) throws IOException {
        ...
        ResourceLocation resourcelocation = new ResourceLocation(shaderLocation.getNamespace(), "shaders/" + shaderLocation.getPath() + ".json");
    ...
    private static Program getOrCreate(final ResourceProvider resourceProvider, Program.Type type, String p_173343_) throws IOException {
        Program program1 = type.getPrograms().get(p_173343_);
        Program program;
        if (program1 == null) {
            ...
            try (InputStream inputstream = resource.open()) {
                ...
                program = Program.compileShader(type, p_173343_, inputstream, resource.sourcePackId(), new GlslPreprocessor() {
                    ...
                    public String applyImport(boolean p_173374_, String p_173375_) {
                        ...
                        if (!this.importedPaths.add(resourcelocation.toString())) {
                            ...
                            try {
                                ...
                                THDanmakuCraftCore.LOGGER.error("Could not open GLSL import {}: {}", resourcelocation, ioexception.getMessage());
